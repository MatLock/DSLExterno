 ...
 * <!-- end-user-doc -->
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getDia()
 * @model
 * @generated
 */
public enum Dia implements Enumerator
{
  ...
  /**
   * The '<em><b>Sabados</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #SABADOS_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Sabados</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Sabados</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #SABADOS
   ...
   * @ordered
   */
  public static final int SABADOS_VALUE = 5;
  ...
  public static Dia get(int value)
  {
    switch (value)
    {
      ...
      case SABADOS_VALUE: return SABADOS;
    }
    return null;
  }
