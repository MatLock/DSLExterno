	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getClaseAccess().getAlternatives(), "rule__Clase__Alternatives");
					put(grammarAccess.getAtributosAccess().getAlternatives(), "rule__Atributos__Alternatives");
					...
					put(grammarAccess.getNumeroDeAulaAccess().getGroup(), "rule__NumeroDeAula__Group__0");
					put(grammarAccess.getCantidadDeDiasAccess().getGroup(), "rule__CantidadDeDias__Group__0");
					put(grammarAccess.getHorariosAccess().getGroup(), "rule__Horarios__Group__0");
					put(grammarAccess.getNombreAccess().getGroup(), "rule__Nombre__Group__0");
					...
					put(grammarAccess.getAsignacionesAccess().getGroup(), "rule__Asignaciones__Group__0");
					...
					put(grammarAccess.getNumeroDeAulaAccess().getNumeroAssignment_1(), "rule__NumeroDeAula__NumeroAssignment_1");
					put(grammarAccess.getCantidadDeDiasAccess().getDiasAssignment_1(), "rule__CantidadDeDias__DiasAssignment_1");
					put(grammarAccess.getHorariosAccess().getHorarioInicionAssignment_1(), "rule__Horarios__HorarioInicionAssignment_1");
					put(grammarAccess.getHorariosAccess().getHorarionFinAssignment_4(), "rule__Horarios__HorarionFinAssignment_4");
					put(grammarAccess.getHorariosAccess().getAulaAssignment_7(), "rule__Horarios__AulaAssignment_7");
					put(grammarAccess.getHorariosAccess().getTypeAssignment_8(), "rule__Horarios__TypeAssignment_8");
					put(grammarAccess.getNombreAccess().getNombreAssignment_1(), "rule__Nombre__NombreAssignment_1");
					put(grammarAccess.getProfesorAccess().getDedicacionAssignment_3(), "rule__Profesor__DedicacionAssignment_3");
					put(grammarAccess.getProfesorAccess().getTypeAssignment_4(), "rule__Profesor__TypeAssignment_4");
					put(grammarAccess.getProfesorAccess().getAtributosAssignment_5(), "rule__Profesor__AtributosAssignment_5");
					put(grammarAccess.getMateriaAccess().getAtributosAssignment_3(), "rule__Materia__AtributosAssignment_3");
					put(grammarAccess.getAulaAccess().getAtributosAssignment_3(), "rule__Aula__AtributosAssignment_3");
					put(grammarAccess.getAulaAccess().getRecursosAssignment_5(), "rule__Aula__RecursosAssignment_5");
					put(grammarAccess.getPlanificacionAccess().getAnioAssignment_2(), "rule__Planificacion__AnioAssignment_2");
					put(grammarAccess.getPlanificacionAccess().getSemestreAssignment_4(), "rule__Planificacion__SemestreAssignment_4");
					put(grammarAccess.getPlanificacionAccess().getMateriasAssignment_8(), "rule__Planificacion__MateriasAssignment_8");
					put(grammarAccess.getPlanificacionAccess().getAsignacionesAssignment_10(), "rule__Planificacion__AsignacionesAssignment_10");
					put(grammarAccess.getAsignacionesAccess().getDiaAssignment_1(), "rule__Asignaciones__DiaAssignment_1");
					put(grammarAccess.getAsignacionesAccess().getHorarioAssignment_3(), "rule__Asignaciones__HorarioAssignment_3");
					put(grammarAccess.getAsignacionesAccess().getMateriaAssignment_5(), "rule__Asignaciones__MateriaAssignment_5");
					put(grammarAccess.getAsignacionesAccess().getTypeAssignment_6(), "rule__Asignaciones__TypeAssignment_6");
