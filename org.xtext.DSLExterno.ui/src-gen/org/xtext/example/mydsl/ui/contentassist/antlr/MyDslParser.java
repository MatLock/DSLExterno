		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMateriaAccess().getRecursosAssignment_8(), "rule__Materia__RecursosAssignment_8");
					...
					put(grammarAccess.getAulaAccess().getCapacidadAssignment_6(), "rule__Aula__CapacidadAssignment_6");
					...
					put(grammarAccess.getPlanificacionAccess().getCursosAssignment_7(), "rule__Planificacion__CursosAssignment_7");
					put(grammarAccess.getPlanificacionAccess().getAsignacionesAssignment_9(), "rule__Planificacion__AsignacionesAssignment_9");
					put(grammarAccess.getCursoAccess().getMateriaAssignment_0(), "rule__Curso__MateriaAssignment_0");
					put(grammarAccess.getCursoAccess().getDictadaPorAssignment_2(), "rule__Curso__DictadaPorAssignment_2");
					put(grammarAccess.getCursoAccess().getInscriptosAssignment_4(), "rule__Curso__InscriptosAssignment_4");
