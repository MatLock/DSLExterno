		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMateriaAccess().getRecursosAssignment_10(), "rule__Materia__RecursosAssignment_10");
					put(grammarAccess.getMateriaAccess().getCantidadDeInscriptosAssignment_12(), "rule__Materia__CantidadDeInscriptosAssignment_12");
					...
					put(grammarAccess.getPlanificacionAccess().getMateriasAssignment_6(), "rule__Planificacion__MateriasAssignment_6");
